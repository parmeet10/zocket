...
const getCampaigns = async (params) => {
  ...
  params.platformId ? getCampaignsQuery.where("pf.id", params.platformId) : null;
  params.hasOwnProperty('active') ? getCampaignsQuery.where('c.active', params.active) : null;
